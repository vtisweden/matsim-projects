 ...
 *
 */
public class VehicleFleetProposal implements MHProposal<VehicleFleet> {

	@Override
	public VehicleFleet newInitialState() {
		return null;
	}

	@Override
	public MHTransition<VehicleFleet> newTransition(VehicleFleet state) {
		return null;
	}
