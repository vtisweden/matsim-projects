 ...
 */
package se.vti.matsim.dynameq.utils;
...
public class Time {
	...
	public static String strFromSec(int time_s, final char separator) {
		...
		time_s -= m * 60;
		final int s = time_s;
		return (h < 10 ? "0" : "") + h + separator + (m < 10 ? "0" : "") + m + separator + (s < 10 ? "0" : "") + s;
	}
	 ...
	 * @author FilipK
	 * 
	 * @return the hour formatted like "XX:00", ex: "07:00"
	 */
	public static String intToHourString(int hour) {
		if (hour < 0 || hour > 24) {
