 ...
 *
 */
public class PossibleTransitionsWithAlternatingLocations<L extends Location> implements PossibleTransitions<L> {
	...
	public PossibleTransitionsWithAlternatingLocations(RoundTrip<L> state, Scenario<L> scenario) {
