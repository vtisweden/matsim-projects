 ...
 * @param <L>
 */
public class RoundTripIgnoreLocationCombinationsWithoutLocationConstraints_DEPRECATED implements MHWeight<RoundTrip<?>> {

	private final double logOfAvailableLocationCnt;

	public RoundTripIgnoreLocationCombinationsWithoutLocationConstraints_DEPRECATED(int availableLocationCnt) {
