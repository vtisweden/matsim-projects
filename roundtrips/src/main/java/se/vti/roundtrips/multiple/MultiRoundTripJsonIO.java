...
public class MultiRoundTripJsonIO {
	...
	public static class Serializer extends JsonSerializer<MultiRoundTrip<? extends Location>> {
		@Override
		public void serialize(MultiRoundTrip<? extends Location> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
	...
	public static void main(String[] args) throws JsonGenerationException, JsonMappingException, IOException {
		...
		multiRoundTrip.setRoundTrip(0, new RoundTrip<>(
				Arrays.asList(new Location("home"), new Location("work")), Arrays.asList(7, 18)));
		multiRoundTrip.setRoundTrip(1, new RoundTrip<>(
				Arrays.asList(new Location("home"), new Location("school")), Arrays.asList(9, 13)));
