...
public class RunBasicModel {
	...
	public static void main(String[] args) {
		...
		final List<SamgodsConstants.Commodity> consideredCommodities = Arrays.asList(SamgodsConstants.Commodity.values()).subList(0, 2);

		/*
		 * Load a samgods scenario.
		 */
//		final SamgodsConstants samgods = new SamgodsConstants(null, null);
