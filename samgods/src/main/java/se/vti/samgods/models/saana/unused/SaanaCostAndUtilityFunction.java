 ...
 */
package se.vti.samgods.models.saana.unused;
 ...
 *
 */
public class SaanaCostAndUtilityFunction {
//		implements ShipmentPrices<ShipmentPrices>, ShipmentUtilityFunction<ShipmentPrices> {
//
//	// -------------------- INNER CLASS --------------------
//
////	class Betas {
...
//
////		Betas(double transportCostCoeff
////				, final double beta_yearlyInTransitCaptialCost, final double beta_valueDensity,
...
//			final ShipmentCost shipmentPrices = this.transportPrices.getShipmentPrices(shipment.getCommmodity(),
//					leg.getMode());
//
//			if (leg == firstLeg) {
...
//
//		return new ShipmentCost(durationSum_min / 60.0, transportCostSum); 
//		// 60.0, transportCostSum, capitalCost, valueDensity);
//	}
//
...
////		final Betas betas = this.commodity2betas.get(shipment.getCommmodity());
////		double utility = betas.transportCostCoeff * shipmentCost.monetaryCost
////				+ betas.inTransitCaptialCostCoeff * shipmentCost.capitalCost
////				+ betas.valueDensityCoeff * shipmentCost.valueDensity;
////		return utility;
//		return 0.001 * shipmentCost.monetaryCost; // TODO ad hoc
//	}
}
