 ...
 *
 */
public class SamgodsShipmentCostFunction implements ShipmentCostFunction<BasicShipmentCost> {

	private final TransportPrices<?, ?> transportPrices;

	public SamgodsShipmentCostFunction(TransportPrices<?, ?> transportPrices) {
