...
public interface TransportCostModel {
	...
	public interface SingleShipmentCost {
	...
	public SingleShipmentCost computeSingleShipmentCost(TransportChain transportChain, Commodity commodity, double shipmentSize_ton);
