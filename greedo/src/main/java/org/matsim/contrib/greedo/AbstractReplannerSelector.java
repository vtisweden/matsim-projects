...
abstract class AbstractReplannerSelector {
	...
	static AbstractReplannerSelector newReplannerSelector(final GreedoConfigGroup greedoConfig) {
		if (GreedoConfigGroup.ReplannerIdentifierType.IID.equals(greedoConfig.getReplannerIdentifier())) {
